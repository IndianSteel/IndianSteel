(function () {
  ...
  const APP_BUILD_VERSION = "20260501-bottom-nav-lift-apk-48";
  const THEME_COLORS = {
    light: "#0d5bdd",
    dark: "#0b1f46"
  };
  ...
  function setupStableViewportHeight() {
    ...
    const update = () => {
      ...
      const navLift = keyboardOpen ? 0 : Math.min(18, Math.max(smallViewportGap, android && (standaloneMode || iosStandalone) ? 12 : 0));
