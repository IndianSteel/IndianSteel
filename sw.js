const CACHE_NAME = "indiansteel-pwa-20260501-dashboard-12";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css",
  "./styles.css?v=20260501-dashboard-12",
  "./app.js",
  "./app.js?v=20260501-dashboard-12",
  "./manifest.webmanifest",
  "./manifest.webmanifest?v=20260501-dashboard-12",
  "./icons/icon.svg",
