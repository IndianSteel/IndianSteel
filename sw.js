const CACHE_NAME = "indiansteel-pwa-20260501-profile-sync-17";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css",
  "./styles.css?v=20260501-profile-sync-17",
  "./app.js",
  "./app.js?v=20260501-profile-sync-17",
  "./manifest.webmanifest",
  "./manifest.webmanifest?v=20260501-profile-sync-17",
  "./icons/icon.svg",
