const CACHE_NAME = "indiansteel-pwa-20260501-dashboard-10";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css",
  "./styles.css?v=20260501-dashboard-10",
  "./app.js",
  "./app.js?v=20260501-dashboard-10",
  "./manifest.webmanifest",
  "./manifest.webmanifest?v=20260501-dashboard-10",
  "./icons/icon.svg",
