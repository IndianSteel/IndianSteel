const CACHE_NAME = "indiansteel-pwa-20260501-profile-icons-16";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css",
  "./styles.css?v=20260501-profile-icons-16",
  "./app.js",
  "./app.js?v=20260501-profile-icons-16",
  "./manifest.webmanifest",
  "./manifest.webmanifest?v=20260501-profile-icons-16",
  "./icons/icon.svg",
